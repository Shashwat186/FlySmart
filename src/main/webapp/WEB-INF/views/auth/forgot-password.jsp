...
<head>
    ...
    <style>
        /* Base Styling with same color scheme */
        :root {
            --color-light: #F5EEDC;
        ...
        .alert-success {
            background: rgba(40, 167, 69, 0.2); /* Example success color */
            color: var(--color-light);
        }

        .alert-info {
            background: rgba(23, 162, 184, 0.2); /* Example info color */
            color: var(--color-light);
        }
...
<div class="container">
    ...
    <c:if test="${not empty message}">
        <div class="alert alert-success"><i class="fas fa-check-circle icon"></i> ${message}</div>
    </c:if>
    <c:if test="${not empty resetLink}">
        <div class="alert alert-info"><i class="fas fa-info-circle icon"></i>
            <p>For testing purposes, here's your reset link:</p>
            <a href="${pageContext.request.contextPath}${resetLink}"><i class="fas fa-link icon"></i> Reset Password</a>
        </div>
    </c:if>
    <form action="${pageContext.request.contextPath}/auth/forgot-password" method="post">
        ...
        <button type="submit" class="btn btn-primary"><i class="fas fa-envelope icon"></i> Reset Password</button>
    </form>
    <div class="mt-3">
