...
<div class="dashboard">
    <header>
        <h1><i class="fas fa-plane icon"></i> Airports</h1>
        <nav>
            ...
            <a href="${pageContext.request.contextPath}/admin/airports" class="active"><i class="fas fa-map-marked-alt icon"></i>Airports</a>
    ...
    <div class="content">
        <div class="actions">
            <div class="search-container">
                <input type="text" id="airportSearch" class="search-bar" placeholder="Search by Name or Code">
                <i class="fas fa-search search-icon"></i>
            </div>
            <a href="${pageContext.request.contextPath}/admin/airports/add" class="btn"><i class="fas fa-plus icon"></i> Add Airport</a>
        </div>
        <table>
            <thead>
                <tr>
                    ...
                    <th><i class="fas fa-phone-alt icon"></i> Contact Info</th>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="actions-container">
                                <a href="${pageContext.request.contextPath}/admin/airports/edit/${airport.airportId}" class="btn"><i class="fas fa-edit icon"></i> Edit</a>
                                <a href="#" onclick="confirmDelete('${pageContext.request.contextPath}/admin/airports/delete/${airport.airportId}', 'airport')" class="btn danger"><i class="fas fa-trash-alt icon"></i> Delete</a>
                            </div>
                        </td>
                    </tr>
                </c:forEach>
