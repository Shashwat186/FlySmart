...
body {
	...
	background: linear-gradient(rgba(24, 59, 78, 0.85),
		rgba(39, 84, 138, 0.85)),
...
header:hover {
	...
	box-shadow: 0 20px 50px rgba(0, 0, 0, 0.4), 0 4px 30px
		rgba(221, 168, 83, 0.2);
}
...
.content:hover {
	box-shadow: 0 15px 35px rgba(0, 0, 0, 0.4), 0 10px 20px
		rgba(221, 168, 83, 0.2);
...
<body>
	...
	<div class="dashboard">
		...
		<header>
			...
			<h1>
				<i class="fas fa-building icon"></i> Add Airline
			</h1>
		...
		<div class="content">
			...
			<h1>
				<i class="fas fa-plus icon"></i> Add New Airline
			</h1>

			<form method="post"
				action="${pageContext.request.contextPath}/admin/airlines/add"
...
<div class="form-group">
  ...
  <input type="text" id="code" name="code" required
         placeholder="Enter 2 letter code" maxlength="2"
         value="${airline.code}">
...
<div class="form-group">
  ...
  <div id="contactError" class="error-message"></div>
				...
				<a href="${pageContext.request.contextPath}/admin/airlines"
					class="btn btn-secondary"><i class="fas fa-times icon"></i>
					Cancel</a>
