...
<body>
    ...
    <div class="dashboard">
        ...
        <div class="error-banner red-text">
            ...
            <form method="post" action="${pageContext.request.contextPath}/manager/airports/edit/${airport.airportId}" onsubmit="return validateEditForm()">
                ...
                <div style="text-align: center; margin-top: 30px;">
                    ...
                    <a href="${pageContext.request.contextPath}/manager/airports" class="btn btn-secondary cancel"><i class="fas fa-times icon"></i> Cancel</a>
                </div>
            </form>
        </div>
    </div>
